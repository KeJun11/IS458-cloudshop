...
export function CheckoutPage() {
  ...
  const handlePlaceOrder = async () => {
    // Validate form
    const requiredFields: (keyof ShippingInfo)[] = ['name', 'email', 'address', 'city', 'zipCode']
            ...
            <VStack spacing={6} align="stretch">
              ...
              <Alert status="info">
                ...
                <VStack align="start" spacing={1}>
                  <Text fontWeight="medium" fontSize="sm">Secure Checkout</Text>
                  <Text fontSize="xs">
                    Your order will be processed through our secure cloud infrastructure.
                  </Text>
                </VStack>
              </Alert>
            </VStack>
